...
namespace Wookashi.ExtraText.Tests
{
    public class TextNormalizationTests
    {
        ...
        [InlineData("ŷ", "y")]
        [InlineData("Ŷ", "Y")]
        public void ReplaceDiacriticalMarks_Welsh_IndividualCharacters(string source, string expected)
        {
            var result = source.ReplaceDiacriticalMarks(Language.Welsh);
            Assert.Equal(expected, result);
        }

        [Theory]
        [InlineData("Cymru", "Cymru")]
        [InlineData("tŷ", "ty")]
        [InlineData("Gwŷdd", "Gwydd")]
        public void ReplaceDiacriticalMarks_Welsh_Sentences(string source, string expected)
        {
            var result = source.ReplaceDiacriticalMarks(Language.Welsh);
            Assert.Equal(expected, result);
        }
        ...
        [InlineData("ü", "u")]
        [InlineData("Ü", "U")]
        public void ReplaceDiacriticalMarks_Dutch_IndividualCharacters(string source, string expected)
        {
            var result = source.ReplaceDiacriticalMarks(Language.Dutch);
            Assert.Equal(expected, result);
        }

        [Theory]
        [InlineData("België", "Belgie")]
        [InlineData("geïnteresseerd", "geinteresseerd")]
        [InlineData("café", "cafe")]
        public void ReplaceDiacriticalMarks_Dutch_Sentences(string source, string expected)
        {
            var result = source.ReplaceDiacriticalMarks(Language.Dutch);
            Assert.Equal(expected, result);
        }
        ...
        [Theory]
        [InlineData("ë", "ë", Language.Dutch)]
        [InlineData("ï", "ï", Language.Dutch)]
        [InlineData("é", "é", Language.Dutch)]
        public void ReplaceDiacriticalMarks_Dutch_ResultDiffersFromSource(string source, string notExpected, Language language)
        {
            var result = source.ReplaceDiacriticalMarks(language);
            Assert.NotEqual(notExpected, result);
        }
        ...
        [Theory]
        [InlineData("â", "â", Language.Welsh)]
        [InlineData("ŵ", "ŵ", Language.Welsh)]
        [InlineData("ŷ", "ŷ", Language.Welsh)]
        public void ReplaceDiacriticalMarks_Welsh_ResultDiffersFromSource(string source, string notExpected, Language language)
        {
            var result = source.ReplaceDiacriticalMarks(language);
            Assert.NotEqual(notExpected, result);
        }
